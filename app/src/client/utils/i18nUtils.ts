 ...
 */
const SUPPORTED_APP_LOCALES = ["en", "fr"] as const;
type Locale = (typeof SUPPORTED_APP_LOCALES)[number];

let _userLocale: Locale, _polarisTranslations: any;
